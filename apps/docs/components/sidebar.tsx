...
export function Sidebar() {
  ...
  return (
    <aside className="fixed top-14 z-30 hidden h-[calc(100vh-3.5rem)] w-[var(--sidebar-width)] shrink-0 border-r border-border md:flex md:flex-col">
                ...
                {section.items.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      className={cn(
                        'flex w-full items-center rounded-md px-4 py-1.5 text-sm transition-colors',
                        isActive
